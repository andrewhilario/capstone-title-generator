  ...
  const getResponseFromOpenAI = async () => {
    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify({
          prompt: `Can you create a 10 examples of capstone thesis titles using ${title} as the strand for Senior High School? and make sure that the titles are unique. You can use the following as a guide: 1. The title should be related to the course. 2. The title should be related to the problem. 3. The title should be related to the solution. 4. The title should be related to the benefits. 5. The title should be related to the objectives. 6. The title should be related to the scope and delimitation. 7. The title should be related to the methodology. 8. The title should be related to the findings. 9. The title should be related to the conclusion. 10. The title should be related to the recommendation. Please make this in a list format and add a colon (:) at the end of each title.`,
        }),
      });
